...
I've created a branch of the latest (as of v2.0.6) Marlin that has been configured for this machine and had the core code slightly modified to handle this application better:
